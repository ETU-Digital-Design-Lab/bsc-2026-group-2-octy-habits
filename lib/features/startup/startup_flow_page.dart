...
class _IntroPageState extends State<IntroPage>
  ...
  static const _poses = <String>[
    'assets/octy/happy.png',
    'assets/octy/love.png',
    'assets/octy/smile.png',
    'assets/octy/wink.png',
  ];
                          ...
                          return AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: selected
                                  ...
                                  : AppTheme.mutedText(context, 0.24),
                            ),
                          );
                        }),
                      ),
  ...
  Future<void> _finishSetup({required bool withSample}) async {
    ...
    if (displayName.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Octy sana nasıl seslensin?')),
      );
      return;
    }
                ...
                child: _GlassPanel(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Adını kaydedelim; Octy ana ekranda sana bununla seslensin.',
                        textAlign: TextAlign.center,
                      ...
                      TextField(
                        ...
                        decoration: const InputDecoration(
                          labelText: 'İlk alışkanlığın',
                          hintText: 'Örnek: Su iç',
                        ),
                      ),
                      const SizedBox(height: 12),
                      ...
                      ElevatedButton(
                        ...
                        child: Text(
                          _saving ? 'Hazırlanıyor...' : 'Takibe başla',
                        ),
                      ),
                      const SizedBox(height: 8),
                      TextButton(
