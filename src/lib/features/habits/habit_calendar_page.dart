...
class _ModeToggle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppTheme.glassFill(context, dark: 0.04),
...
class _WeekLabels extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final days = mondayFirst
        ...
        : const ['Paz', 'Pzt', 'Sal', 'Çar', 'Per', 'Cum', 'Cmt'];
    return Row(
      children: days
          .map(
            (d) => Expanded(
...
class _DayCell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final color = isDone
        ? const Color(0xFF36D3B2).withValues(alpha: inCurrentPeriod ? 0.9 : 0.5)
        : AppTheme.mutedText(context, inCurrentPeriod ? 0.08 : 0.04);
    ...
    return Container(
      ...
      child: Text(
        ...
        style: Theme.of(context).textTheme.bodyLarge?.copyWith(
          color: inCurrentPeriod
              ? Theme.of(context).colorScheme.onSurface
              : AppTheme.mutedText(context, 0.38),
        ),
      ),
    );
  }
...
class _Legend extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final swatches = [
      AppTheme.mutedText(context, 0.07),
    ...
    return Row(
      children: [
        Text(
          ...
          style: Theme.of(
            context,
          ).textTheme.bodyMedium?.copyWith(color: AppTheme.mutedText(context)),
        ),
