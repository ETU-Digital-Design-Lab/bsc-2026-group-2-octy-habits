...
class _AiAssistantPageState extends ConsumerState<AiAssistantPage> {
  static const String _aiEndpoint = String.fromEnvironment(
    'OCTY_AI_ENDPOINT',
  ...
  final List<_ChatMessage> _messages = [
    const _ChatMessage(
      ...
      text:
          'Ben Octy. Bugün hangi alışkanlıkta takıldığını yaz, birlikte net bir plan çıkaralım.',
    ),
  ];
  bool _sending = false;
  bool _seeded = false;
  ...
  Future<void> _send({
    ...
    ref
        ...
        .logEventSafe(type: 'assistant_message', data: {'length': text.length});
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          filled: true,
                          fillColor: AppTheme.glassFill(context),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(
        ...
        style: Theme.of(
          context,
        ).textTheme.labelLarge?.copyWith(color: AppTheme.mutedText(context)),
      ),
    );
  }
